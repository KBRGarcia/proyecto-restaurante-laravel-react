...
/**
* @see \App\Http\Controllers\ApiAuthController::register
...
* @see app/Http/Controllers/ApiAuthController.php:72
* @route '/api/logout'
*/
...
* @see app/Http/Controllers/ApiAuthController.php:82
* @route '/api/me'
*/
...
const ApiAuthController = { login, register, logout, me }
