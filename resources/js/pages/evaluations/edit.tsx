...
export const EvaluationsEdit = () => {
    ...
    const [manualEvaluatorType, setManualEvaluatorType] = useState<EvaluatorType | null>(null);
    const evaluatorType = manualEvaluatorType ?? (evaluation?.client_id ? "client" : "user");
    ...
    const { selectProps: clientSelectProps } = useSelect({
        ...
        optionValue: "id",
        defaultValue: evaluation?.client_id,
    });
