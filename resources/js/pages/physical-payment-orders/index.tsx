...
import { Edit, Eye, Plus, Search, Trash2, Receipt } from 'lucide-react';
                                        ...
                                        {physicalPaymentOrdersData.data.length > 0 ? (
                                            physicalPaymentOrdersData.data.map((physicalPaymentOrder) => (
                                                <tr key={physicalPaymentOrder.id} className="hover:bg-muted/50">
                                                    ...
                                                    <td className="px-4 py-3 text-sm">
                                                        <div className="flex items-center gap-2">
                                                            <Link href={physicalPaymentOrders.show(physicalPaymentOrder.id).url}>
                                                            ...
                                                            <Button 
                                                                variant="ghost" 
                                                                size="sm"
                                                                onClick={() => handleDelete(physicalPaymentOrder.id)}
                                                            >
