...
import { Form, Input, Select, InputNumber, Checkbox, Row, Col, Upload, Button, Avatar, Card } from "antd";
        ...
        <Create saveButtonProps={saveButtonProps}>
            <Form {...formProps} layout="vertical">
                <Row gutter={[16, 16]} align="stretch">
                    <Col xs={24} lg={18}>
                        <Card title="Datos del Plato" style={{ height: "100%" }}>
                            <Row gutter={16}>
                    ...
                    <Col xs={24} lg={6}>
                        <Card title="Estado del Plato" style={{ height: "%" }}>
                            <Row gutter={16}>
                                <Col xs={24} sm={12}>
                                    <Form.Item
                                        label="Estado"
